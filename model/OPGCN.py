...
class OP_conv(nn.Module):
    def __init__(self, in_channels, out_channels, A, adaptive=True, residual=True, att=False, CoM=21):
        ...
        self.conv_mh = nn.Conv2d(out_channels, out_channels, kernel_size=1)
    ...
    def forward(self, x):
        ...
        if self.att:
            ...
            out_sum = out.sum(dim=2, keepdim=False)
            out_max = out.max(dim=2, keepdim=False)[0]
            out_max = self.conv_mh(out_max)
...
class TCN_GCN_unit(nn.Module):
    def __init__(self, in_channels, out_channels, A, stride=1, residual=True, adaptive=True,
        ...
        self.gcn1 = OP_conv(in_channels, out_channels, A, adaptive=adaptive, att=att, CoM=CoM)
